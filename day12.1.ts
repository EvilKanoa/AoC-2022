...
const computeShortestPath = (heightMap: HeightMap): number => {
  ...
  distanceCache[heightMap.start[0]][heightMap.start[1]] = 0;
  nextSearch.push(heightMap.start);
...
benchmark(() => {
  ...
  result = computeShortestPath(heightMap);
});
